    ...
    var ShieldProgress = function (_BaseProgress) {
        ...
        _createClass(ShieldProgress, [{
            ...
            value: function __drawProgress() {
                ...
                if (ctx) {
                    ...
                    if (me.curVal >= 0 && this.totalPoints) {
                        ...
                        ctx.fillStyle = '#eee';
                        ctx.beginPath();
                        ctx.arc(dotPoint[0], dotPoint[1], 5, 0, Math.PI * 3);
                        ctx.fill();
            ...
            value: function __drawLabel() {
                ...
                ctx.fillText(this.curVal, center_x, center_y + 25);
                
                ctx.font = '600 18px "Microsoft YaHei"';
                ctx.textAlign = 'center';
                ctx.fillText('分', center_x+40, center_y + 20);
                
                ctx.font = '600 20px "Microsoft YaHei"';
                ctx.fillStyle = '#000';
                ctx.fillText('风险指数', center_x, center_y - 20);
            }
        }, {
            key: '__dynamicDraw',
            value: function __dynamicDraw(length) {
